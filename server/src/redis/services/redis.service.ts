...
import { createClient, defineScript, RedisClientType, RedisDefaultModules, RedisScripts } from 'redis'
...
export class RedisService implements OnApplicationBootstrap, OnApplicationShutdown {
  ...
  readonly client: RedisClientType<RedisDefaultModules, Record<string, never>, Scripts>
